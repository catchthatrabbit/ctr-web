...
export const useFetchAllBlocks = (
  ...
  const resultArray = useQueries({
    queries: [
      {
        queryKey: [QUERY_KEYS.MATURED, region, limit, offset],
        queryFn: () => fetchMatured(region, limit, offset),
        ...DEFAULT_REACT_QUERY_OPTIONS,
      },
      {
        queryKey: [QUERY_KEYS.IM_MATURED, region, limit, offset],
        queryFn: () => fetchImMatured(region, limit, offset),
        ...DEFAULT_REACT_QUERY_OPTIONS,
      },
      {
        queryKey: [QUERY_KEYS.CANDIDATES, region, limit, offset],
        queryFn: () => fetchCandidates(region, limit, offset),
        ...DEFAULT_REACT_QUERY_OPTIONS,
      },
    ],
  });
