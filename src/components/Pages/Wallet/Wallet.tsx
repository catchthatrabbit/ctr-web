    ...
    return(
        <>
            ...
            <Panel title="Connections">
                <PanelContent>
                    <Text variant="body" type="value">Direct link to stats:&nbsp;</Text><Text variant="body" color="primary"
                     type="value" decorating="link">
                        {`${walletAddress}.ctr.watch`}</Text>
                    <br />
                    <Text variant="body" type="value">Direct link.</Text>
                </PanelContent>
            </Panel>
