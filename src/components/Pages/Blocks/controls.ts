...
const useControls = () => {
    ...
    const {region, handleChangeRegion} = useHeaders({defaultRegion:POOL_NAME_ENUM.EU});
    ...
    const dataTableColumns = useMemo(() => [
        {value:'height', label: 'Height', isPrimary:true, href:EXTERNAL_URL[EXTERNAL_URL_ENUM.BLOCK_DETAILS]}, 
        {value:'type', label: 'Type', alignToCenter:true}, 
        {value:'minedOn', label: 'Mined on', alignToCenter:true},
        {value:'blockHash', label: 'Block hash', alignToCenter:true, isPrimary:true, href:EXTERNAL_URL[EXTERNAL_URL_ENUM.BLOCK_DETAILS]},
