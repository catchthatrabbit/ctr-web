...
export const convertPaymentsResponse2PaymentInfo = (paymentResponse:PAYMENTS_RESPONSE):Array<{address: string, 
    address_summarized:string, amount: string,
    timestamp: string, tx: string, tx_summarized:string}> => {
