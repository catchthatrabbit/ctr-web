...
import { Mouse, MouseContent } from "../../Molecules/InsideChart/Mouse";
...
const Dashboard = ({onSetWalletAddress}:IDashboard) => {
    ...
    const {infoBoxMapData, asStarMiningPoolLocation, euStarMiningPoolLocation, usStarMiningPoolLocation, 
        estd, poolFee, infoBoxRadialData, radialChartData, recentMatureBlockListColumns, AllRegionsMaturedBlocks} = useControls();
        
    return(<div className="container">
        <Spacer variant="xxxxl" />
        <MapChart infoItems={infoBoxMapData}>
            <div className="row">
        ...
        <Spacer variant="xl" />
        <StatsChart infoItems={infoBoxRadialData} radialBarChart={<RadialBarChart data={radialChartData} />} />
        <Spacer variant="xl" />
        <RecentBlocksTitle />
        <Spacer variant="xl" />
        <List dataTableColumns={recentMatureBlockListColumns} hidePagination 
