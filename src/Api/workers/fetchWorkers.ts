...
export const fetchWorkersByWalletAddress = async ({region, walletAddress, limit=10, offset=0}:
    ...
    try{
        ...
        const response = instance.get(`/workers/${walletAddress}?limit=${limit}&offset=${offset}`) as Promise<AxiosResponse<WORKER_BY_WALLET_ADDRESS_RESPONSE>>;
